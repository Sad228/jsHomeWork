...
for (const coursesAndDurationArrayElement of coursesAndDurationArray) {
    ...
    div1.innerText = coursesAndDurationArrayElement.title + ' ' + coursesAndDurationArrayElement.monthDuration
    divMain.append(div1);
}
...
for (const coursesAndDurationArray2Element of coursesAndDurationArray2) {
    ...
    head.innerText = coursesAndDurationArray2Element.title;
    let pad = document.createElement('p');
    pad.classList.add('description');
    pad.innerText = coursesAndDurationArray2Element.monthDuration;
    div2.appendChild(head);
    div2.appendChild(pad);
}
